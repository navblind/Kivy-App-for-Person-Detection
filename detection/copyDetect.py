...
# parser.add_argument("--prototxt", default="detection/MobileNetSSD_deploy.prototxt",
#                                   help='Path to text network file: '
#                                        'MobileNetSSD_deploy.prototxt for Caffe model or '
#                                        )
# parser.add_argument("--weights", default="detection/MobileNetSSD_deploy.caffemodel",
